...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference('Participant.count') do
      post participants_url, params: { participant: { mail: @participant.mail, name: @participant.name, telegram_user: @participant.telegram_user } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { mail: @participant.mail, name: @participant.name, telegram_user: @participant.telegram_user } }
